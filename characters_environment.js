...
function game(){
  console.log("X value of nose is "+ noseX);
  console.log(" and the Y value of nose is "+ noseY)
  instializeInDraw();
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press The Start Game Button To Play Have a Lot of Fun. ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function changeGameStatud(character){
  if(gameStatus=="STARTING...."&& noseX != "" && gameConfig.status==="start") {
